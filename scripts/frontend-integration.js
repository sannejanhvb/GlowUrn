 ...
 * This file demonstrates how to integrate Glowurn with a web frontend
 */

// For React/Vue/Angular applications
export class GlowurnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new GlowurnClient(provider, contractAddress);
